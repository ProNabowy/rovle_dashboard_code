            ...
            <form onSubmit={e => e.preventDefault()} className='col-span-6'>
                ...
                <div className='mb-6'>

                    {
                        hasAddButton
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <h2 className='text-[18px] text-[#252525] font-medium'>Size</h2>

                                <Link to={'/products/plans/size/list/add-size'} className='flex items-center cursor-pointer'>

                                    <h2 className='font-medium underline text-[#45B8EA] me-3'>Add Size</h2>
                    ...
                    <Dropdown
                        ...
                        placeholder={placeholder || "Select Size"} className="w-full p-2  !shadow-none !rounded-none !border-t-transparent !border-l-transparent !border-r-transparent" />
