...
export default function PageContent({
    ...
    const isHasPermissions = hasRoutePermissions(userPeressmisons, roleKey);
    ...
    return (
        ...
        <section className='rounded-[20px] my-10' style={{ boxShadow: "rgba(126, 124, 152, 0.1) 0px -2px 8px 3px" }}>
            ...
            <div className='p-4 px-10 border-b flex items-center justify-between flex-wrap rounded-tl-[20px] rounded-tr-[20px]' style={{ boxShadow: "0px -2px 4px 0px rgba(126, 124, 152, 0.10)" }}>

                <h1 className='sm:text-[20px] lg:text-[30px] font-medium text-[#252525] mb-3 sm:mb-0 text-center sm:text-start w-full sm:w-fit'>{title}</h1>

                {
                    showActions
                        ?
                        <div className='flex items-center flex-wrap m-auto sm:m-[initial]'>

                            <div className='relative w-full sm:w-fit'>

                                <button onClick={HandleExport} className='w-full flex items-center justify-center sm:justify-[initial] my-3 sm:my-0 relative z-30 bg-white py-3 px-3 sm:px-5 lg:px-8 rounded-full border border-[var(--primary-color)] me-5'>
                                    ...
                                    <span className='ms-3 text-[var(--primary-color)] text-[13px] lg:text-[16px] font-medium'>Exportar</span>
...

                            {
                                isHasPermissions
                                    ...
                                    <Link className={`${addnewClassNames} w-full sm:w-fit ms-0 sm:ms-3`} to={url}>

                                        <button className='!w-full sm:w-fit flex items-center justify-center sm:justify-[initial] py-3 px-3 sm:px-5 lg:px-8 rounded-full bg-[var(--primary-color)] text-white  border border-[var(--primary-color)]'>

                                            <FontAwesomeIcon icon={faPlus} className='text-[16px] lg:text-[20px]' />

                                            <span className='ms-3 text-white font-medium text-[13px] lg:text-[16px] text-nowrap'>Añadir nuevo</span>
