...
export default function PageContent({
    ...
    const { exportPDF, exportExcel } = useExportTable(exportPDFColumns, list, exportedExcelList);

    return (

        <section className='rounded-md sm:rounded-[20px] my-5 sm:my-10' style={{ boxShadow: "rgba(126, 124, 152, 0.1) 0px -2px 8px 3px" }}>

            <div className='p-4 px-10 border-b flex items-center justify-center sm:justify-between flex-wrap rounded-md sm:rounded-tl-[20px] sm:rounded-tr-[20px]' style={{ boxShadow: "0px -2px 4px 0px rgba(126, 124, 152, 0.10)" }}>
                    ...
                    showActions
                        ...
                        <div className='flex items-center flex-row justify-center gap-3'>
                            ...
                            <div className='relative'>
                                ...
                                <button onClick={_ => setVisible(perv => !perv)} className='flex items-center relative z-30 bg-white p-2 sm:py-3 sm:px-8 rounded-md sm:rounded-full border border-[var(--primary-color)]'>
                                    ...
                                    <span className='sm:ms-3 text-[var(--primary-color)] text-[14px] sm:text-base font-medium'>Exportar</span>
                                ...
                                <ul className={`shadow-lg p-2 pb-0 transition bg-white left-[-10px] mt-[-5px] rounded-[5px] absolute z-20 w-full ${visible ? "opacity-100 scale-100 visible" : "opacity-0 scale-0 invisible"}`}>
                                    ...
                                    <li onClick={exportExcel} className='flex items-center cursor-pointer p-2 text-[13px]'>
...

                            {
                                isHasPermissions && url
                                    ...
                                    <Link className={`${addnewClassNames} w-full sm:w-fit ms-0`} to={url}>
                                        ...
                                        <button className='!w-full sm:w-fit text-[14px] sm:text-base flex items-center justify-center sm:justify-[initial] p-2 sm:py-3 sm:px-5 lg:px-8 rounded-md sm:rounded-full bg-[var(--primary-color)] text-white  border border-[var(--primary-color)]'>
                                            ...
                                            <FontAwesomeIcon icon={faPlus} className='text-[16px] lg:text-[20px] hidden sm:inline' />
            ...
            <div className='py-5 sm:py-14 relative'>
