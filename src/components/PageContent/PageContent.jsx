...
export default function PageContent({
  ...
  const { exportPDF, exportExcel } = useExportTable(
    exportPDFColumns,
    list,
    exportedExcelList
  );
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("click", (_) => setVisible(false));
  });

  return (
    <section
      className="rounded-md sm:rounded-[20px] my-5 sm:my-10"
      style={{ boxShadow: "rgba(126, 124, 152, 0.1) 0px -2px 8px 3px" }}
    >
      <div
        className="p-4 px-10 border-b flex items-center justify-center sm:justify-between flex-wrap rounded-md sm:rounded-tl-[20px] sm:rounded-tr-[20px]"
        style={{ boxShadow: "0px -2px 4px 0px rgba(126, 124, 152, 0.10)" }}
      >
        <h1 className="sm:text-[20px] lg:text-[30px] font-medium text-[#252525] mb-3 sm:mb-0 text-center sm:text-start w-full sm:w-fit">
          {title}
        </h1>
          ...
          <div className="flex items-center flex-row justify-center gap-3">
            <div className="relative">
              <button
                ...
                className="flex items-center relative z-30 bg-white p-2 sm:py-3 sm:px-8 rounded-md sm:rounded-full border border-[var(--primary-color)]"
              >
              ...
              >
                <li
                  onClick={exportPDF}
                  className="flex items-center cursor-pointer p-2 mb-1 border-b text-[14px]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <li
                  onClick={exportExcel}
                  className="flex items-center cursor-pointer p-2 text-[13px]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
      ...
      <div className="py-5 sm:py-14 relative">{children}</div>
    </section>
  );
}
