...
export default function TableActions({ rowData, handelDeleteFunction, disableEdit }) {
    ...
    const handleClick = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                handelDeleteFunction && handelDeleteFunction(rowData.id);
    ...
    return (
        ...
        <div className='flex items-center relative '>
            ...
            <span className={`cursor-pointer me-5 ms-10 ${disableEdit ? "hidden" : ""}`}>
