...
import { handleLogOut } from '../../assets/utils/utils';
    ...
    return (
        <header className='relative shadow py-3 sm:px-3 mb-5'>
            ...
            <div className='container rounded-bl rounded-br flex items-center justify-center sm:justify-end lg:justify-between'>
                ...
                <span className='me-4 cursor-pointer hidden lg:block' onClick={_ => setIsExpanded(!isExpanded)}>
                ...
                <div className='relative flex items-center'>
                    ...
                    <div onClick={handleOpenMnue} className='border rounded-full min-w-[200px] flex items-center justify-between p-2 px-5 cursor-pointer relative'>
                        ...
                        <img
                            ...
                            width={'fit-content'}
                            height={'fit-content'}
                            className='rounded-full w-[39px] h-[39px] me-2'
                        />
