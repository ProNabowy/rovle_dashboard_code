import { GoogleMap, PageContent } from '../../components';
...
// Define the selectedPlace variable here
const selectedPlace = {
    name: 'Some Place',
};
    ...
    return (
        <PageContent title={'Coffee Form'} showActions={false}  >
            <form onSubmit={e => e.preventDefault()} className='px-10'>
                ...
                {renderFlexInputs(['Name', 'Post Code'], ['Enter Name', 'Enter Post Code'], setData, ['name', 'post_code'])}
