        ...
        <form onSubmit={e => e.preventDefault()}>
            ...
            <div className='p-10 pb-2'>
                ...
                <input type='text' name="name" value={formik.values?.name} onChange={formik.handleChange}
                    className='p-3 px-5 placeholder:!text-[#b3b3b3] border-b border-b-[#b3b3b3] w-full' placeholder='Ingresar Nombre de la Ciudad' />

            </div>

            <div className='p-10 pt-2'>

                <label htmlFor='name-input' className='mb-3 block text-[#234486]'>Provincia</label>
