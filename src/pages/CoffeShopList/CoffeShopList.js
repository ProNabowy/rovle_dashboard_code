...
import CoffeShopTable from './CoffeShopTable';
...
export default function CoffeShopList() {
    ...
    return (
        ...
        <PageContent
            url={'add-coffee'} title={'Roasters Form'} showActions={true} >

            <Dialog header="Roasters Form" visible={dialogVisible} style={{ width: '75vw' }} maximizable={true}
                maximized={true} modal contentStyle={{ height: '300px' }} onHide={() => setDialogVisible(false)} footer={dialogFooterTemplate} >
            ...
            <div className='flex items-center justify-between px-10 mb-5'>
                ...
                <div onClick={() => setDialogVisible(true)} className='flex items-center cursor-pointer  text-[#45B8EA]'>

                    <h3 className='font-medium me-5'>Show all</h3>
