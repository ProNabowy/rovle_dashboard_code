...
export default function TableHeader({ ingredients, setIngredients, data }) {
    ...
    return (
        <Fragment>
            ...
            <Dialog header="Roasters Form"
                ...
                <OfferListTable data={data} countOfEntries={13} />
