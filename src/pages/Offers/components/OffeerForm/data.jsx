...
const useDataGetter = (formik) => {
  ...
  useEffect(() => {
    if (formik.values.start_date === null) {
      setAutoSelectStartData(true);
    }
    if (formik.values.end_date === null) {
      setAutoSelectEndData(true);
    }
...
const Fisico = [{ id: "coffeeShop", name: "FISICO" }];
const AppFisico = [
