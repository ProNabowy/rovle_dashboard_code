        ...
        <div className="w-[48%]">
            ...
            <div className='flex items-center'>
                ...
                <div className="flex items-center cursor-pointer me-5">
                    ...
                    <label htmlFor="ingredient1" className={`ms-2 font-medium ${formik.values?.status === "active" ? "text-[#28C76F]" : "text-[#2525256d]"}`}>Active</label>
                ...
                <div className="flex items-center cursor-pointer">
                    ...
                    <label htmlFor="inactive" className={`ms-2 font-medium ${formik.values?.status === "inactive" ? "text-[#28C76F]" : "text-[#2525256d]"}`}>In Active</label>
