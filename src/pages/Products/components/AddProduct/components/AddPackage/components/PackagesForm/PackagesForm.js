...

                {
                    getSelectedOption(roasters, 'id', formik?.values?.provider_id)?.manage_stock
                        ...
                        <div className='mb-6'>
                            ...
                            <input ref={inputQuntiyRef} onChange={e => setAddNewPackage(prev => ({ ...prev, units: e.target.value }))} type='number' id={'Quantity'} className='p-3 w-full border-b border-b-[#b3b3b3] placeholder:text-[#b3b3b3]' placeholder={'Quantity'} />
