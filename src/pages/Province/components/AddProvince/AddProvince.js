        ...
        <PageContent title={'Add Province'} showActions={false}>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className='p-10 pb-2'>
                    ...
                    <input type='text' name="name" onChange={formik.handleChange} className='p-3 px-5 placeholder:!text-[#b3b3b3] border-b border-b-[#b3b3b3] w-full' placeholder='Enter Country Name' />
