...
export default function RoastersList() {
    ...
    return (
        ...
        <PageContent url={'add-roaster'} title={'Roasters Form'} showActions={true}>
            ...
            <Dialog header="Roasters Form" visible={dialogVisible} style={{ width: '75vw' }}
                maximizable={true} maximized={true} modal
                contentStyle={{ height: '300px' }} onHide={() => setDialogVisible(false)} footer={dialogFooterTemplate} >
